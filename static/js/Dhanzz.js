(function($) {
     ...
     * Menu Toggle
    /* ---------------------------------------------- */
    Dhanzz.MenuTogglerClose = function() {
                ...
                if ($(".lightbox-gallery").exists()) {
                    $('.lightbox-gallery').magnificPopup({
                        ...
                        gallery: {
                            ...
                            preload: [0, 1] // Will preload 0 - before current, and 1 after Dhanzz current image
                        }
                    });
                }
